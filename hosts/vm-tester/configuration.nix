...
# nix-shell -p disko
# sudo disko --mode disko --flake .#wirtual
# sudo nixos-install --no-channel-copy --no-root-password --flake .#wirtual --arg disks '[ "/dev/vda" ]'
...
#   };
  ...
  # Because this is configured for VMs, NixOS needs to know that
